...
export class ServericonCommand extends ProxiaCommand {
    ...
    if (!icon) {
      await interaction.followUp({
        embeds: [
          {
            title: interaction.getString("global.ERROR"),
            description: interaction.getString("general.COMMAND_SERVERICON_NOICON", {
              server: guild.name,
            }),
            color: this.bot.config.colours.error,
          },
      ...
      embeds: [
        {
          ...
          author: {
            ...
            name: interaction.getString("general.COMMAND_SERVERICON_DESCRIPTION", {
              server: guild.name,
            }),
          },
          image: {
